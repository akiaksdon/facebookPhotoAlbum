...
$permissions = ['email', 'user_likes','user_photos','publish_actions']; // optional
...
<div class="container">
  <div class="row">
    <h1 class="text-center">Facebook Albums Assignment</h1>
        <p class="text-center"><a href="<?php echo $loginUrl ;?>" class="btn btn-primary btn-lg" role="button">Log in with Facebook!</a></p>
  </div>
</div>
 </body>
</html>
